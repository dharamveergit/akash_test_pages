      ...
      <div className="container ">
        <div className="mt-6 flex flex-col justify-between gap-x-6 pb-6 md:mt-8 md:pb-8 lg:mt-10 lg:flex-row lg:border-b lg:pb-10">
          ...
          <div className="flex w-full flex-1 items-center justify-between gap-x-[32px]  lg:flex-row-reverse lg:justify-start lg:gap-x-[36px]">
            ...
            <div className="relative  inline-flex h-9 w-24 items-center justify-between  rounded-md border  bg-background2 px-2 pl-6 text-center text-xs leading-[18px]  text-foreground transition-all duration-300 ease-in-out focus-within:w-[50%]  focus-within:pl-2 md:h-11   md:w-32 md:pl-8 md:pr-4  md:text-base md:font-bold ">
              {searchIconVisible && (
                <button
              ...
              <input
                ref={ref}
                type="text"
                className=" h-full w-full rounded-lg bg-transparent p-1 outline-none  placeholder:font-normal placeholder:text-foreground"
                placeholder="Search"
